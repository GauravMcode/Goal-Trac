                ...
                tabs: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                        color: _tabController.index == 0 ? widget.backgroundColor ?? Colors.white : widget.unselectedTabBackgroundColor ?? Colors.grey[200],
                    ...
                    child: Text(
                      ...
                      style: TextStyle(color: _tabController.index == 0 ? (widget.tabTextColor ?? Colors.black87) : (widget.unselectedTabTextColor ?? Colors.black87)),
                    ),
                  ),
                  Container(
                    height: 48,
                    alignment: Alignment.center,
                    decoration: BoxDecoration(
                        color: _tabController.index == 1 ? widget.backgroundColor ?? Colors.white : widget.unselectedTabBackgroundColor ?? Colors.grey[200],
                        borderRadius: BorderRadius.only(
                          topLeft: widget.borderRadius ?? const Radius.circular(16),
                          topRight: widget.borderRadius ?? const Radius.circular(16),
                        )),
                    child: Text(
                      ...
                      style: TextStyle(color: _tabController.index == 1 ? (widget.tabTextColor ?? Colors.black87) : (widget.unselectedTabTextColor ?? Colors.black87)),
                    ),
                  ),
                ],
              ),
