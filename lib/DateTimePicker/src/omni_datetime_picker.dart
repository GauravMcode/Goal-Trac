            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.only(topLeft: widget.borderRadius ?? const Radius.circular(16), topRight: widget.borderRadius ?? const Radius.circular(16)),
                ),
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Center(
                      child: widget.displayTitle, //to display title text
                    ),
                    CalendarDatePicker(
